...
function scoreColorClass(score: number): string {
	...
	if (score >= 65) return "text-emerald-500/90";
			...
			<div className="max-w-6xl mx-auto px-6 py-8">
				...
				<div className="mb-6 space-y-4">
					...
					<div className="flex flex-wrap items-center justify-between gap-4">
						<div className="flex flex-wrap items-center gap-4">
							...
							<Button
								...
								size="sm"
								className="h-8 border-white/10 text-xs font-semibold font-sans"
								onClick={() => {
									setHide95(!hide95);
									setPage(1);
								}}
						...
						{!loading && (
							<div className="text-zinc-400 text-xs font-semibold font-sans">
					...
					<div className="flex flex-wrap items-center gap-4 pt-1">
						...
						<div className="flex items-center gap-2">
							...
							>
								<SelectTrigger className="w-[110px] h-8 bg-zinc-800 border-white/10 text-zinc-200 text-xs font-semibold font-sans">
									<SelectValue />
								</SelectTrigger>
						...
						<div className="flex items-center gap-2">
							...
							>
								<SelectTrigger className="w-[100px] h-8 bg-zinc-800 border-white/10 text-zinc-200 text-xs font-semibold font-sans">
									<SelectValue />
								</SelectTrigger>
								<SelectContent className="bg-zinc-800 border-white/10 text-zinc-200 font-sans">
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
						{markets.map((gm) => {
							...
							return (
								<Card
									key={gm.condition_id}
									className="border-white/5 bg-zinc-900/60 shadow-2xl overflow-hidden hover:border-white/10 hover:bg-zinc-900/80 transition-all duration-200 flex flex-col gap-4"
								>
									{/* Card Header area */}
									...
									<CardContent className="p-5 pt-0 pb-1 space-y-1">
										<div className="flex justify-between text-[10px] font-semibold text-zinc-400 font-sans">
											<span className="text-emerald-400">Smart {gm.smart_yes_pct}% Y</span>
											<span className="text-rose-400">{gm.smart_no_pct}% N</span>
										</div>
										<div className="h-1.5 w-full rounded-full bg-zinc-800/40 overflow-hidden flex">
											<div
									...
									<CardContent className="p-5 pt-0 flex-1">
										<div className="border border-white/5 rounded-lg overflow-hidden bg-zinc-950/40">
											{/* Position Table Headers */}
											<div className="grid grid-cols-[1fr_35px_45px_45px_70px_80px] gap-2 px-3 py-1.5 border-b border-white/5 text-[9px] uppercase font-bold tracking-wider text-zinc-500 font-sans bg-zinc-900/30">
												<span>Trader</span>
											...
											<div className="max-h-[220px] overflow-y-auto divide-y divide-white/5 [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-zinc-950/20 [&::-webkit-scrollbar-thumb]:bg-white/10 [&::-webkit-scrollbar-thumb]:rounded-full hover:[&::-webkit-scrollbar-thumb]:bg-white/20">
												{gm.positions.map((pos) => {
													...
													return (
														<div
															...
															className="grid grid-cols-[1fr_35px_45px_45px_70px_80px] gap-2 px-3 py-2 items-center hover:bg-white/[0.015] transition-colors text-xs font-sans"
														>
															{/* Trader info */}
																	...
																	<div className="flex items-center gap-1.5 min-w-0">
																		{pos.user_name ? (
																			<a
																				...
																				target="_blank"
																				rel="noopener noreferrer"
																				className="text-zinc-200 hover:text-emerald-300 font-medium truncate max-w-[80px]"
																				title={pos.user_name}
																			>
																				{pos.user_name}
																			</a>
																			...
																			<span
																				className="text-zinc-400 font-medium truncate max-w-[80px]"
															...
															{/* Position Value */}
															<span className="text-right font-mono text-[11px] tabular-nums text-zinc-200 font-semibold">
				...
				<Pagination className="mt-8">
					<PaginationContent>
						...
						<PaginationItem>
							<span className="flex h-9 items-center px-4 text-xs font-semibold text-zinc-400 font-sans">
								Page {page}
							</span>
						</PaginationItem>
						<PaginationItem>
